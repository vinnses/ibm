...
app.layout = html.Div([
    ...
    html.Main([
        ...
        html.Section([
            ...
            html.P(["Fontes: ", html.A("Resolução 34/2010-CEPE", href="/documentos/document-2011-resolution-34-2010"),
                    " e ", html.A("Resolução 75/22-CEPE", href="/documentos/document-2023-resolution-75-22"),
