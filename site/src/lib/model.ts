...
export interface EvolutionRelation { id: string; source_occurrence_ids: string[]; target_occurrence_ids: string[]; change_type: ChangeType; evidence_strength: EvidenceStrength; evidence_ids: string[]; notes: string; review_state: ReviewState; is_fixture: boolean; candidate_method: string; similarity_score: string | null; analysis_provenance: string }
