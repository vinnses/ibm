...
Integrated snapshot after W025: 201 datasets, 191 curated source-manifest records and 33 curated human-question/search records. Counts are records, not unique documents or unresolved gaps. Work-local W022-W025 datasets expose bounded public Ficha searches for all coded 2011 components and all 43 curriculum-2023 targets; they are not folded into the older curated unions. Remaining applicability and term/class gaps require institutional evidence.
