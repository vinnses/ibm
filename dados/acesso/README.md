...
Integrated snapshot after W021: 41 datasets, 191 source-manifest records and 33 human-question/search records. Counts are records, not unique documents or unresolved gaps. All 40 preserved Ficha PDFs have structured records, and 75 stable curricular provisions cover TCC, internship, formative activities and extension across 2011/2023. Existing applicability and institutional-access limits are unchanged unless the original record and newer evidence explicitly establish otherwise.
