...
Updated by W030 after final local extraction. N1-N6 and the final data-closure audit are complete with documented exceptions; the release is available at `dados/entrega-documental/README.md`. The items below are evidence-intake routes only if files, access or a genuinely new lead become available. No agent-actionable collection/extraction task or analytical Work is active.
...
2. **N3, locally preserved source families:** complete. W030 extracted the CPA workbook and corrected the twelve-PDF W022-W024 local representation omission.
...
| D05 / stable administrative data | **Complete for current agent-actionable scope:** W026 applicant targets and W030 CPA extraction | Ten applicant outcomes plus CPA structural inventory, faithful cell layer, 132 response rows and source-bound normalized tables | Terra/medium retrieval; Luna/medium extraction; primary review | Applicant counts not located for 2018, 2025 and 2026; final occupancy/cutoff remains HR-W011-003. No further public search without a new lead |
...
W030 completed CPA and the overlooked W022-W024 local extraction, then refreshed D09 to 217 indexed CSV datasets and 212 source-manifest records. D06 can reopen only for a genuinely new lead; D07/D08 require supplied or precisely located institutional documents. No collection/extraction or analysis phase is active.
