...
- Escalation: ambiguous structure returns to primary for routing; Terra/high only if necessary and recorded before use. No Sol subagent. Sol-requiring work returns to the primary.
