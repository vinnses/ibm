...
| W006 | Administrative historical data | Complete for the bounded public-source search | `5b5423d`; merged by `5ca4b28` | UFPR annual series, INEP cohorts 2011–2020, vacancy points, methods, scripts, audit, claim validation | Raw INEP packages are not repository-preserved; occupancy, complete applicant counts, evaluation data, and older acts remain |
| W007 | ChatGPT Work consolidation and local Codex governance | Complete when merged to `main` | Governance commit containing this index; administrative merge `5ca4b28` | `AGENTS.md`, `governance/`, repository validator, corrected hashes | Future work must follow the new contracts |
